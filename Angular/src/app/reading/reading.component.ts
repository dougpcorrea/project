...
export class ReadingComponent implements OnInit {
  ...
  ngOnInit() {
    this.dataService.get_settings().subscribe(respo => {
        ...
        this.dataService.getData().subscribe(
            ...
            this.musicSrc = `../../../assets/books/${this.allBooks.filter(x => x.id == this.audioId)[0].filename}`,
            this.coverSrc = `../../../assets/${this.allBooks.filter(x => x.id == this.audioId)[0].cover}`
  ...
  nextBook(){
    ...
    this.musicSrc = `../../../assets/books/${this.allBooks[i].filename}`
    this.coverSrc = `../../../assets/${this.allBooks[i].cover}`
    this.audio.nativeElement.load()
